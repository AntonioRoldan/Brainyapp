...
import com.example.antonio.brainyapp.Sliders.Brainstem_slider;
import com.example.antonio.brainyapp.Models.Section;
import com.example.antonio.brainyapp.R;

import java.util.List;

public class BrainstemAdapter extends RecyclerView.Adapter<BrainstemAdapter.ViewHolder>{

    private List<Section> listSections;
    private Context context;

    public BrainstemAdapter(List<Section> listSections, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position){
        ...
        final Intent Brainstemslider = new Intent(this.context, Brainstem_slider.class);
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(listSection.getName() == "What is the brainstem?"){
                    context.startActivity(Brainstemslider);
                }
            }
        });
    }
