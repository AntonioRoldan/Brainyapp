...
import com.example.antonio.brainyapp.Sliders.Corpuscallosum_slider;
import com.example.antonio.brainyapp.Models.Section;
import com.example.antonio.brainyapp.R;

import java.util.List;

public class CorpusAdapter extends RecyclerView.Adapter<CorpusAdapter.ViewHolder>{

    private List<Section> listSections;
    private Context context;

    public CorpusAdapter(List<Section> listSections, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position){
        ...
        final Intent slider = new Intent(this.context, Corpuscallosum_slider.class);
